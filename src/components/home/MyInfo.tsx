...
const dict: Record<Lang, {
  ...
  es: {
    title: 'imnotapan — Game developer y designer',
    description: 'Portafolio de imnotapan (Kevin Medina), game developer y designer. Pixel art, VFX, UI/UX y desarrollo de videojuegos.',
    role: 'Game developer y designer',
    altAvatar: 'Avatar de imnotapan (Kevin Medina)',
    social: { twitter: '> Twitter', instagram: '> Instagram', github: '> Github', email: '> Email' },
  },
  en: {
    title: 'imnotapan — Game developer and designer',
    description: 'Portfolio of imnotapan (Kevin Medina), game developer and designer. Pixel art, VFX, UI/UX and game development.',
      ...
      >
        <div className="flex w-full justify-center lg:ml-64 md:ml-64 ml-16">
          ...
          <div>
            ...
            {/* Socials */}
            <nav
              className="relative z-50 mt-4 flex flex-col hidden md:block"
